...
PHYML_SCRIPT = "./PhyML-3.1/PhyML-3.1_win32.exe"
...
if __name__ == "__main__":
	...
	for d in lsdir:
		...
		output_filename = run_phyml(msa_filepath=dataset_path.format(d)+'/real_msa.phy', full_model=args.model,topology_tag=args.topology_tag,tree_file=args.tree_filepath, force_run=args.runover, copy_msa=args.cpmsa)

		print(f"DONE phyml execution: file {d}", output_filename.format("tree"))
